...
- ["An unsolicited guide to good research", Eugene Vinitsky](https://emerge-lab.github.io/papers/an-unsolicited-guide-to-good-research.pdf)
	...
	- What does bad research looks like?
	- What are the stages towards being developed as a good researcher?
		- Build small experimental/theoretical projects on top of other people's work that close small gaps. (Do lots of this!)
			- This stage has a nice corollary of escaping the **no ideas hole**.
		- Once part I is done, larger methodical, logical, conceptual gaps will be identifiable.
