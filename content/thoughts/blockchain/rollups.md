...
3. [[sovereign-rollups|Sovereign Rollups]]: doesn't use another L1 for settling, and only use another DA layer for data and ordering. These type of rollups have full control over their stack and can outperform other alt-L1s.
...
1. [[fraud-proofs|Fraud Proofs]]: in case of ORUs
...
These are another class of [[sovereign-rollups|Rollups]] that doesn't settle to any other external layer and only use them for DA and transaction ordering.
