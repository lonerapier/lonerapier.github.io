...
- Our goal is to find $\Delta w$ to minimize $-\lVert g \rVert^{\dagger}\lVert \Delta w \rVert+\frac{\lambda}{2}\lVert \Delta w \rVert^{2}$. Let $u=\lVert\Delta w\rVert$, taking the gradient, we get $u=\lVert g \rVert^{\dagger} / \lambda$.
