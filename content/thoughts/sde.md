...
- Thirdly, we want to the starting position of the differential equation $x_{0}=0$.
$$
\begin{equation}
...
- $\mathbb{E}[x_{T}]=\mathbb{E}\left[ \int_{t=0}^{T}dx_{t} \right] =0$
...
- Stationary Gaussian increments: $W_{t+u}-W_{t}\sim \mathcal{N}(0,u)$. The displacement of the particle over an interval is Gaussian distributed with mean 0 and variance proportional to the interval. We just proved this above.
