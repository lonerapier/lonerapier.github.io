...
For me, creativity is anything that can inspire someone. A creator is a complicated organism. He can be selfish yet so selfless at the same time. He can be smart but so dumb on other things. I watched a [video](https://youtu.be/w3WYdYyjek4?si=uKvk1O-SVIDLUsgn) recently where founder of TigerBettleDB was giving a talk on how to design distributed systems in which he talked about how most of the programmers can be categorised into two: a painter or a sculptor. And it was so intuitive to me, because to me code that looks/feels good is good.
